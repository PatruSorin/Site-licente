...
if ($rowcount == 0) {
    ...
    if (strcmp($password, $password2) == 0) {
        ...
        $query = "INSERT INTO utilizatori (nume, prenume, email, data, facultate, specializare, grupa, username, parola, tip_cont ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

        $stmt = mysqli_prepare($dbc, $query);

        mysqli_stmt_bind_param($stmt, "ssssssissi", $nume, $prenume, $email, $data, $facultate, $specializare, $grupa, $username, $password, $tip_cont);
